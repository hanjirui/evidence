    ...
    public void parse(String dic) throws IOException {
        ...
        for (String fileName : fileNameList) {
            ...
            if (pingHangParserSupports.getParseContext().lastNode() == null) {
                ...
                pingHangParserSupports.getParseContext().addNode(CategoryLevel.ROOT, PingHangTitle.RootLevel.REPORT_SUMMARY, true, ModelType.REPORT_SUMMARY, null);
...
//        pingHangParserSupports.getParseContext().printTree();
    ...
    private Parser confirmTreeNodeAndParser(CategoryLevel categoryLevel, String category) {
        boolean leafFlag = false;
        ModelType modelType = null;
        Parser parser = null;
        if (CategoryLevel.ROOT == categoryLevel) {
